...
def run_trainings():
    ...
    movies_train = ["friends-s01","friends-s02", "friends-s03", "friends-s06", "friends-s04", "friends-s05", "movie10-bourne",  "movie10-wolf"] # @param {allow-input: true}
    #movies_train = ["movie10-wolf"] # @param {allow-input: true}
    movies_train_val = ["friends-s02"]
    movies_val = ["life"] # @param {allow-input: true}c
    training_handler = 'sklearn'
    experiment_comments = 'features for episode run time'
