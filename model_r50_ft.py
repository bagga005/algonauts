...
class VisionR50FineTuneModel(nn.Module):
    def __init__(self, input_size, output_size, device, dropout_rate=0.2):
        super(VisionR50FineTuneModel, self).__init__()
...
#learner = RegressionHander_Vision(32768, 1000, enable_wandb=False)
#learner.load_model('lora-20')
